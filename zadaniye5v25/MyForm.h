...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->сохранитьToolStripMenuItem->Size = System::Drawing::Size(226, 26);
			...
			this->выходToolStripMenuItem->Size = System::Drawing::Size(226, 26);
			...
			this->графикToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::графикToolStripMenuItem_Click);
			// 
			...
			this->label6->Text = L"Таблица значений на промежутке [XN;XK]";
			// 
			// tabPage3
			// 
